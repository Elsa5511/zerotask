...
class Organization extends \Application\Entity\Organization implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'organizationId', 'name', 'type', 'description', 'address', 'city', 'status', 'phone', 'zip', 'contactPerson', 'email', 'fax', 'url', 'dateAdd', 'dateUpdate', 'country'];
        }
    ...
    public function setOrganizationId($id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrganizationId', [$id]);

        return parent::setOrganizationId($id);
    }
    ...
    public function getTypeReadable()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeReadable', []);

        return parent::getTypeReadable();
    }
