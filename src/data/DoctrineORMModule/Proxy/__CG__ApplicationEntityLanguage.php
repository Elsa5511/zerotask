...
class Language extends \Application\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'languageId', 'name', 'isocode', 'status', 'dateAdd', 'dateUpdate'];
        }
    ...
    public function setId($languageId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setId', [$languageId]);

        return parent::setId($languageId);
    }
    ...
    public function setDateUpdate($date)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateUpdate', [$date]);

        return parent::setDateUpdate($date);
    }
