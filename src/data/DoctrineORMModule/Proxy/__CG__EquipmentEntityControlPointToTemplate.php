 ...
 */
class ControlPointToTemplate extends \Equipment\Entity\ControlPointToTemplate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'controlPoint', 'controlTemplate', 'order'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ControlPointToTemplate $proxy) {
    ...
    public function getControlPoint()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getControlPoint', []);

        return parent::getControlPoint();
    }
    ...
    public function setControlPoint($controlPoint)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setControlPoint', [$controlPoint]);

        return parent::setControlPoint($controlPoint);
    }
