...
class LoadLashingPointFieldset extends PointFieldset {
    ...
    public function __construct($objectManager, $translator, $mode = 'add') {
        ...
        $attachmentFieldset = new PointAttachmentFieldset($objectManager, $mode, 
            'LadocDocumentation\Entity\LoadLashingPointAttachment', 
            new \LadocDocumentation\Entity\LoadLashingPointAttachment());
        $attachmentFieldset->setTranslator($translator);     
        $elements[5] = array(
            'type' => 'Zend\Form\Element\Collection',
            'name' => 'loadLashingPointAttachments',
            'options' => array(
