...
namespace ApplicationTest\MockUtil;
...
class ServiceManagerMocker extends \PHPUnit_Framework_TestCase {
    ...
    public function setupFormFactoryMock($result) {
        ...
        $factoryMock->expects($this->any())
                ->method('createUserFormForNewUser')
    ...
    public function getUserFormMockWithValidateResult($mockClass, $result) {
        ...
        $fieldDisplayOptions = new \Application\Form\User\FieldDisplayOptions(true, true, true, false);
        
        $interfaceElement = new \Application\Form\User\UserFieldset($this->objectManager, $fieldDisplayOptions, 'ectypted-password');
