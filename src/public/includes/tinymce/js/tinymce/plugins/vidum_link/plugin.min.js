tinymce.PluginManager.add("vidum_link",function(e){
    function t(t){
        return function(){
...
function n(t){
    function n(e){
        ...
        var n=[
            {text:"None", value:""},
            {text:"Modal", value:"bootstrap-modal"}
        ];
    ...
    u=g.getNode(),s=m.getParent(u,"a[href]"),x.text=c=s?s.innerText||s.textContent:g.getContent({
        format:"text"
    }),x.href=s?m.getAttrib(s,"href"):"",x.target=s?m.getAttrib(s,"target"):"",x.rel=s?m.getAttrib(s,"rel"):"","IMG"==u.nodeName&&(x.text=c=" "),t&&(d={
        type:"listbox",
        label:"Link list",
        values:l(),
        onselect:n,
